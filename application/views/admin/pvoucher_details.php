            ...
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-bars"></i> <?=" Voucher No : ".$this->uri->segment(4)?></h3>
                 <?//=anchor("admin_sale_print/pvoucher_print/pvoucher/","Print",'class="btn btn-default"')?>
              ...
              foreach($lists->result() as $list):
                  ...
                  ?>
                  <tr>
                    <td align="right" colspan="5">All Total </td>
                     <td align="center"> <?=number_format($total)?></td>
                      <td><button onclick="window.print()" class="btn btn-default">Print</button></td>
                    </tr>
                  </tbody>
                  </table>
