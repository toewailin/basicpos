            ...
            <div class="panel panel-primary">
              ...
              <div class="container">
              <div class="col-md-2">
                <h3 class="panel-title"><i class="fa fa-bars"></i> Income Category</h3>
              </div>
              <div class="col-md-9">
                   <form name="getreport" id="income_category">
              ...
              <input type="button" class="btn btn-primary" value="<?=$search?>" onclick="searchsingle('income_category')">
             </form> 
              </div>
              <div class="col-md-1 text-right">    
 

                   <a href="javascript:show_form('income_category_form')" class="btn btn-default active"><?=$addnew?></a> 
