...
?>
 <div class="container">
              <table class="table table-bordered table-hover tablesorter">
                ...
                <tbody>
                 <tr>
                 <td align="right" width="20%"><label>Customer Name:</label></td>
                  ...
                  <tr>
                    ...
                    <td><?=form_input('require',abs($row->total_debt<0 ? $row->total_debt : 0),'class="form-control"')?></td>
                    </tr>
                     <tr>
                    <td align="right">   <label><?="ပိုေငြ"?></label></td>
                    <td><?=form_input('exceed',abs($row->total_debt>0 ? $row->total_debt : 0),'class="form-control"')?></td>
                    </tr>
