...
<tr>  
<td>  <?=$customername?>  <br>Phone </td> 
<td> 
  <span id="old_customer">
<?=form_dropdown("customer",$customer,"..select.."," onchange='check_debt(this.value,\"customer\")' autocomplete='off'  class='form-control-discount' id='old_customer'");?>
</span>
 <input type="text" name="phone" class="form-control-discount" placeholder="09-xxxxxxxxx"/>

 </td>
 <td><input type="button" onclick="add_cus()" class="mybutton btn btn-default" value="+"></td>
</tr>
...
<td>   
<?=form_input("voucherno","","class='form-control-discount'");?>
</td></tr>

 <tr>
    
      <td>Note</td>
     <td><textarea name="note" class="form-control-discount"></textarea></td>
...
<tr>  <td align="right"> Salesman :</td> <td align="left">   <?=get_cookie("admin_cookie")?>
</td></tr>

<tr>  <td align="right"> Staff :</td> <td>   <?=form_dropdown("staff",$staff,"","class='form-control-discount'")?>
</td></tr>
