     <div class="panel panel-primary">
              <div class="panel-heading heading-over">
               ...
               <div class="container">
                    ...
                    <div class="col-md-3">
                  <h3 class="panel-title"><i class="fa fa-bars"></i> Warehouse (1) Damage Lists</h3>
                  </div>
            ...
            <div class="col-md-1 text-right"> 
                  ...
                  <?=anchor("cashier/insert_form/damage_warehouse1_form",$addnew,'class="btn btn-default active"')?>
