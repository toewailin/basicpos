...
<?=form_open('',' class="cloneable-form" id="warehouse2" ');?>

 <div class="container">
 <table class="table table-bordered table-hover tablesorter"> 
 <caption> <h1> <small>Godaung Stock (2) Form</small></h1>
</caption> 
...
<?=form_hidden("category[]","")?>
     ...
     <tr>
       <td colspan="4" align="right"><?php echo form_button('save',$save,'class="btn btn-primary btn-lgy" onclick="insert_form(\'warehouse2\')"');?></td>
     </tr>
 </table>
