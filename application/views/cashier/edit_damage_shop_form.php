    ...
    <h5><?php echo $errmessage; ?></h5>
     <?=form_open("admin/edit_damage_shop","id='damage_shop'");
     echo form_hidden('id',$row->id);?>
 <div class="container">
              <table class="table table-bordered table-hover tablesorter">
                          <caption>  <h1> <small>ဆိုင္ကုန္အပ်က္အစီးစာရင္း ျပင္ရန္ </small></h1></caption>
                <tbody>
                 <tr>
                 ...
                 <tr>
                    ...
                    <td> </td>
                    <td><?php echo form_button('save',$save,'class="btn btn-primary btn-lgy" onclick="update_data(\'damage_shop\')"');?></td>
                </tr>
                </tbody>
              </table>
</div>
