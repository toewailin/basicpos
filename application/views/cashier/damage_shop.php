   <div class="panel panel-primary">
              <div class="panel-heading heading-over">
               ...
               <div class="container">
                    ...
                    <div class="col-md-2">
                  <h3 class="panel-title"><i class="fa fa-bars"></i> Shop Damage Lists</h3>
                  </div>

                  <div class="col-md-9">
                     <form name="singlesearch" id="damage_shop">
               ...
               Value <input type="text" name="search" class="form-control-sale" onkeyup="searchsingle('damage_shop')"/>
          
              <input type="button" class="btn btn-primary active" value="<?=$search?>" onclick="searchsingle('damage_shop')">
            ...
            <div class="col-md-1 text-right"> 
                  ...
                  <?=anchor("admin/insert_form/damage_shop_form",$addnew,'class="btn btn-default active"')?>
