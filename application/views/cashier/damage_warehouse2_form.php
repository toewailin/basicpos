 ...
 <h1 > <small>Warehouse (2) Damages Entry Form</small></h1>

<?=form_open("",'class="cloneable-form" id="damage_warehouse2"');?>
              ...
              <table class="table table-bordered table-hover tablesorter">
                ...
                <tr class="clonethis">
                  ...
                  <tr>
                    ...
                    <td align="right" colspan="5"><?php echo form_button('save',$save,'class="btn btn-primary btn-lgy" onclick="insert_form(\'damage_warehouse2\')"');?></td>
                </tr> 
