...
<h3 class="title">Sale Return Form</h3>



 <?=form_open("","id='sale_return' 'class='cloneable-form'")?>
...
<td colspan="4" align="right">
 <?php echo form_button('save','SAVE','class="btn btn-primary btn-lgy" onclick="insert_form(\'sale_return\')"');?>
