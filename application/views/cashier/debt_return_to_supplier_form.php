...
<input type="hidden" name="voucherno" value="<?=$this->uri->segment(5)?>" />
 <div class="container">
              <table class="table table-hover tablesorter">
                          <caption><h1> <small>Debt Return To Supplier Form</small></h1>
</caption>
                <tbody>
                 <tr>
                 <td align="right" width="20%"><label><?=$returnamount?> : </label></td>
                  ...
                  <tr>
                    <td align="right"> </td>
                    <td><?php echo form_button('save',$save,'class="btn btn-primary btn-lgy" onclick="return_debt(\'debt_to_supplier\')"');?></td>
                </tr>
                </tbody>
              </table>
            </div>
